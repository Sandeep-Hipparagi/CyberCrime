...
import { FileCheck, Shield, CheckCircle2, AlertTriangle, ArrowRight, Eye, Edit, Printer, Clock, Database, Lock, Hash, Building2, IndianRupee, Phone, Zap, ShieldCheck, Sparkles } from 'lucide-react';
import { AppScreen, ComplaintData, EvidenceItem } from '../../types';
import { EvidencePreviewModal } from '../modals/EvidencePreviewModal';
import { AIRiskAssessmentCard } from '../common/AIRiskAssessmentCard';
  ...
  return (
    <div className="w-full max-w-[1050px] mx-auto px-4 sm:px-6 pt-2 pb-16 space-y-8">
      ...
      <div className="space-y-6">
        ...
        {/* AI-Powered Fraud Threat Pattern & Risk Assessment Section */}
        <AIRiskAssessmentCard
          narrative={complaintData.narrative}
          complaintType={complaintData.complaintType}
          financialLoss={bank.amountLost}
        />
